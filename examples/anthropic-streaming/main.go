// anthropic-streaming demonstrates streaming responses with the Anthropic provider.
...
func main() {
				...
				Blocks: []*llmprovider.Block{
					{
						...
						Sequence:    0,
						TextContent: helpers.StrPtr("Write a haiku about Go programming."),
					},
				},
			},
		},
	...
	for event := range eventChan {
		...
		if event.Metadata != nil {
			...
			// Print any extra metadata (cache hits, etc.)
